...
import { ArrowLeft, Calendar as CalendarIcon, FileText, AlertCircle, ChevronLeft, ChevronRight, X, Eye, EyeOff } from 'lucide-react-native';
      ...
      <SafeAreaView style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            const displayDate = item.request_date ? item.request_date.substring(0, 10) : '—';
            ...
            return (
              <View style={styles.historyCard}>
                ...
                <View style={styles.cardBody}>
                  <FileText size={16} color={isLight ? "#64748B" : colors.textSecondary} />
...
const getDynamicStyles = (colors, isLight) => StyleSheet.create({
  ...
  type: { fontFamily: 'Inter_18pt-Bold', fontSize: 14, color: isLight ? '#334155' : colors.textPrimary },
  ...
  attachmentBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: isLight ? '#F1F5F9' : colors.border },
